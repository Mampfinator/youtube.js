 ...
 */
export interface ItemIdentifier<T extends string = string>
    extends Etag,
        Kind<T>,
        ID {}
...
export interface ListResponse<
    ...
    TItem extends ItemIdentifier,
> extends ResourceIdentifier<TKind>,
        PageInfo {
    items: TItem[];
}
...
export type Override<
    ...
    TOverride extends Partial<Record<keyof TSource, any>>,
> = TOverride & Pick<TSource, Exclude<keyof TSource, keyof TOverride>>;
...
export type Replace<
    TSource extends object,
    TReplace extends keyof TSource,
    TNew,
> = {
