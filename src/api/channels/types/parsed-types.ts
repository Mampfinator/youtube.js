...
import {
    ChannelIdentifier,
    ChannelResourceParts,
    ContentOwnerDetails,
    Snippet,
} from "./api-types";

export type ParsedChannelParts = Override<
    ChannelResourceParts,
    {
...
export type Channel<TPart extends ChannelPart> = ChannelIdentifier &
    Pick<ParsedChannelParts, TPart>;
