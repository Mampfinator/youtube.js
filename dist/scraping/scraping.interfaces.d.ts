...
export type FlatResult<T, E = Error> = T extends Result<infer TValue, infer TError> ? TValue extends Result<any, any> ? FlatResult<TValue> : Result<TValue, TError> : Result<T, E>;
export type FetchReturn<TTransform extends FetchTransform | undefined> = Promise<FlatResult<TTransform extends undefined ? string : ReturnType<TTransform & Function>, FetchError>>;
export interface FetchOptions<TTransform extends FetchTransform | undefined = undefined> extends Pick<Dispatcher.DispatchOptions, "method" | "query"> {
    url: string;
    /**
